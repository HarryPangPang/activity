<template>
  <div class="index-content" >
    ...
    <div v-show="coupons.length === 0">
      <img src="./images/无优惠券-icon@2x.png" class="none-coupon">
      <div class="none-coupontext">暂无领取记录</div>
    </div>
    <!--优惠券-->
    ...
    <!--暂无领取记录text-->
    <div class="record-text" v-show="coupons.length === 0">
      <div class="h1-text">赶快邀请小伙伴来帮你助力</div>
      <div class="h1-text">凭券“冰点”特价 88.8 、38.8 、18.8 元</div>
      <div class="h1-text">享原价 388 元奢侈品护理</div>
    </div>
    ...
    <!--助力完成text-->
    <div class="record-text record-text-left" v-show="coupons.length === 3">
      <div class="h1-text">全部助力完成</div>
      <div class="h1-text">赶快去APP下单使用吧</div>
    </div>
...
<script lang="ts">
  ...
  export default class cBrecords extends Vue {
    order: any;
    newUrl:any;
    openId:string;
    code:string;
...
//      this.code = args.code;
      ...
      // this.openId = 'oABxXv1kr-pkl_ZfnPc7mwL3A1gk';
      // this.openId = 'oABxXv0ZRTmslfKQgRxGg26ddo';
      this.getCoupons();
